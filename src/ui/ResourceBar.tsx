...
function fmt(d: Decimal): string {
  const n = d.toNumber()
  if (!isFinite(n) || d.gte(new Decimal('1e15'))) return d.toExponential(2)
    ...
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-2 bg-slate-900/95 border-b border-slate-700 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-amber-300 font-bold text-sm leading-none">{fmt(nb)}</div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-indigo-300 font-bold text-sm leading-none">{soldiers}</div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-purple-300 font-bold text-sm leading-none">{infantry}</div>
        ...
        {archers > 0 && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-green-300 font-bold text-sm leading-none">{archers}</div>
        ...
        {cavalry > 0 && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-amber-300 font-bold text-sm leading-none">{cavalry}</div>
        ...
        {mages > 0 && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-blue-300 font-bold text-sm leading-none">{mages}</div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-red-300 font-bold text-sm leading-none">{fmtNum(dps)}</div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-slate-300 text-sm leading-none">{totalClicks.toLocaleString()}</div>
