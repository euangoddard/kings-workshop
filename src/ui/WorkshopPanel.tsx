    ...
    >
      <div className="w-full flex flex-col items-center gap-3">
        ...
        <div className="w-full grid grid-cols-2 gap-2 text-center">
          ...
          <div className="bg-slate-800/70 rounded-lg p-2 border border-slate-700">
            <div className="text-slate-300 font-bold text-lg">{totalSoldiersSpawned}</div>
        ...
        <button
          ...
          disabled={!canAfford}
          className={`
            w-full py-3 rounded-lg border-2 font-bold text-sm transition-all duration-100 select-none
            ${canAfford
        ...
        >
          ...
          <div className={`text-xs mt-1 font-normal ${canAfford ? 'text-indigo-300' : 'text-slate-600'}`}>
