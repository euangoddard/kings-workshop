...
function defaultAchievements(): Achievement[] {
  return [
    // Production
    {
      id: "first_100",
      name: "Scrap Hunter",
      description: "Earn 100 total N&B",
      unlocked: false,
    },
    {
      id: "first_1k",
      name: "Scrap Collector",
      description: "Earn 1,000 total N&B",
      unlocked: false,
    },
    {
      id: "first_10k",
      name: "Hoarder",
      description: "Earn 10,000 total N&B",
      unlocked: false,
    },
    {
      id: "first_100k",
      name: "Treasure Trove",
      description: "Earn 100,000 total N&B",
      unlocked: false,
    },
    {
      id: "first_1m",
      name: "Royal Fortune",
      description: "Earn 1,000,000 total N&B",
      unlocked: false,
    },
    // Army
    {
      id: "first_soldier",
      name: "First Recruit",
      description: "Spawn 1 soldier",
      unlocked: false,
    },
    {
      id: "infantry_5",
      name: "Shieldwall",
      description: "Equip 5 infantry",
      unlocked: false,
    },
    {
      id: "infantry_10",
      name: "Iron Guard",
      description: "Equip 10 infantry",
      unlocked: false,
    },
    {
      id: "first_archer",
      name: "Marksmen",
      description: "Equip first archer",
      unlocked: false,
    },
    {
      id: "archer_5",
      name: "Arrow Storm",
      description: "Equip 5 archers",
      unlocked: false,
    },
    {
      id: "first_cavalry",
      name: "Cavalry Charge",
      description: "Equip first cavalry",
      unlocked: false,
    },
    {
      id: "first_mage",
      name: "Arcane Power",
      description: "Equip first mage",
      unlocked: false,
    },
    {
      id: "full_army",
      name: "Full Army",
      description: "Have all 4 troop types (1+ each)",
      unlocked: false,
    },
    {
      id: "upgrade_1",
      name: "Blacksmith's Touch",
      description: "Buy any troop upgrade",
      unlocked: false,
    },
    // Clicks
    {
    ...
    },
    {
      id: "elite_slayer",
      name: "Elite Slayer",
      description: "Defeat first elite boss",
      unlocked: false,
    },
    // Collector
    {
      id: "first_upgrade",
      name: "Automation",
      description: "Buy first collector upgrade",
      unlocked: false,
    },
  ];
}
...
function checkAchievements(s: GameState): Achievement[] {
  ...
  const updated = s.achievements.map((a) => {
    ...
    switch (a.id) {
      case "first_100":
        shouldUnlock = s.totalNutsAndBoltsEarned.gte(100);
        break;
      case "first_1k":
        shouldUnlock = s.totalNutsAndBoltsEarned.gte(1000);
        break;
      case "first_10k":
        shouldUnlock = s.totalNutsAndBoltsEarned.gte(10000);
        break;
      case "first_100k":
        shouldUnlock = s.totalNutsAndBoltsEarned.gte(100000);
        break;
      case "first_1m":
        shouldUnlock = s.totalNutsAndBoltsEarned.gte(1000000);
        break;
      case "first_soldier":
        shouldUnlock = s.totalSoldiersSpawned >= 1;
        break;
      case "infantry_5":
        shouldUnlock = s.infantry >= 5;
        break;
      case "infantry_10":
        shouldUnlock = s.infantry >= 10;
        break;
      case "first_archer":
        shouldUnlock = s.archers >= 1;
        break;
      case "archer_5":
        shouldUnlock = s.archers >= 5;
        break;
      case "first_cavalry":
        shouldUnlock = s.cavalry >= 1;
        break;
      case "first_mage":
        shouldUnlock = s.mages >= 1;
        break;
      case "full_army":
        shouldUnlock =
          s.infantry >= 1 && s.archers >= 1 && s.cavalry >= 1 && s.mages >= 1;
        break;
      case "upgrade_1":
        shouldUnlock =
          s.infantryUpgrades.damage > 0 ||
          s.infantryUpgrades.health > 0 ||
          s.infantryUpgrades.special > 0 ||
          s.archerUpgrades.damage > 0 ||
          s.archerUpgrades.health > 0 ||
          s.archerUpgrades.special > 0 ||
          s.cavalryUpgrades.damage > 0 ||
          s.cavalryUpgrades.health > 0 ||
          s.cavalryUpgrades.special > 0 ||
          s.mageUpgrades.damage > 0 ||
          s.mageUpgrades.health > 0 ||
          s.mageUpgrades.special > 0;
        break;
      case "clicks_100":
        shouldUnlock = s.totalClicks >= 100;
        break;
      case "clicks_1k":
        shouldUnlock = s.totalClicks >= 1000;
        break;
      case "clicks_10k":
        shouldUnlock = s.totalClicks >= 10000;
        break;
      case "first_boss":
        shouldUnlock = s.totalBossesDefeated >= 1;
        break;
      case "boss_5":
        shouldUnlock = s.totalBossesDefeated >= 5;
        break;
      case "elite_slayer":
...
// Default fresh state
// ---------------------------------------------------------------------------
const defaultUpgrades = (): TroopUpgrades => ({
  damage: 0,
  health: 0,
  special: 0,
});
